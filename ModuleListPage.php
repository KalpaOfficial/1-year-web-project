        ...
        <section class="exam-section">
            ...
            <div class="subject-dropdown">
                <details>
                    ...
                    ?>
                                <summary><?php echo $row['course_name']; ?></summary>
                                <ul class="course-list">
                                    <li><a href="eng101.html"><?php echo $row['module_1']; ?></a></li>
                                    <li><a href="eng102.html"><?php echo $row['module_2']; ?></a></li>
                                    <li><a href="eng103.html"><?php echo $row['module_3']; ?></a></li>
                                    <li><a href="eng104.html"><?php echo $row['module_4']; ?></a></li>
                                    <li><a href="eng105.html"><?php echo $row['module_5']; ?></a></li>
                                </ul>
                    <?php
                            }
                        }
            ...
            <!-- Back Button -->
            <button onclick="window.location ='examPage.php';" id="backButton">Back</button>
        </section>
