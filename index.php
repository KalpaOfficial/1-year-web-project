...
<body>
    <div class="container">
        ...
        <div class="photo">
            ...
            <div class="overlay">
                <h2 id="welcomeMessage">Hi <?php echo htmlspecialchars($username); ?>,<br>Let’s get started with your exams or check your latest results!</h2>
            </div>
        </div>
        ...
        ?>
            ...
            <div class="sections">
                <div class="exam" onclick="window.location.href='examPage.php';"><a href="#">Exam</a></div>
                <div class="result" onclick="window.location.href='ModuleListPage.php';"><a href="#">Result</a></div>
                <div class="Support" onclick="window.location.href='ModuleListPage.php';"><a href="#">Support</a></div>
                <div class="aboutus" onclick="window.location.href='ModuleListPage.php';"><a href="#">About Us</a></div>
            </div>
